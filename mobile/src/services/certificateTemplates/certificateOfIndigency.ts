...
/**
 * Generate HTML for Certificate of Indigency
 */
export async function generateCertificateOfIndigencyHTML(data: CertificateData): Promise<string> {
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="certification-text">
        ...
        Surigao City, and is personally known to me.
      </p>
      ...
      <p class="purpose-section">
        This certification is issued upon request for <strong>${purpose.toUpperCase()}</strong>
    ...
    <div class="official-seal">
      ...
      <p style="font-size: 8pt; font-style: italic;">Not valid without official seal</p>
    </div>
  </div>
</body>
</html>
